...
public class CandyMachine {
  ...
  public static void main(String[] args) {
        ...
        System.out.println("1. CHIPS = P 29.00");
        System.out.println("2.  GUM = P 28.00");
        System.out.println("3. COOKIES P 40.00");
        int sel = sc.nextInt();

        if(sel == 1 ){
            System.out.println("You select a CHIPS = P 29.00");
            int chips = 29;
            ...
            System.out.println("You select a GUM = P 28.00");
            int GUM = 28;
            ...
            System.out.println("You select a COOKIES = P 40.00");
            int cookies = 40;
